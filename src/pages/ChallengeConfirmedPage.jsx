            ...
            <div style={{ background: '#FFFFFF', border: '1px solid #E4DACE', borderRadius: 12, padding: '1rem 1.1rem', margin: '1.2rem 0' }}>
              ...
              {tier === 'challenge-vip' && (
                <div style={{ display: 'flex', gap: '0.6rem', padding: '0.32rem 0', fontSize: '0.93rem', borderBottom: '1px solid #F2EAE0' }}>
                  ...
                  <span style={{ color: '#6A7A78' }}>Bonus Day VIP Q&amp;A hour (time + link by separate email)</span>
                </div>
              )}
              <p style={{ margin: '0.7rem 0 0', fontSize: '0.93rem', color: '#4A5A58' }}>
                ...
                {tier === 'challenge-vip'
                  ? ' Your VIP Q&A hour is Bonus Day, Sunday, September 27; its time and its own Zoom link come in a separate email, so expect two emails from us.'
                  : ''}
              </p>
            </div>

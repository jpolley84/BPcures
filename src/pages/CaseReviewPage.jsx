...
import { track, getDistinctId, getAbHomeVariant, getFirstTouchUtm } from '../utils/analytics';
        ...
        checkout = await stripe.initEmbeddedCheckout({
          fetchClientSecret: async () => {
            const res = await fetch('/api/create-embedded-checkout', {
              ...
              body: JSON.stringify({ tier: 'casereview3', email, ph_did: getDistinctId(), ab_variant: getAbHomeVariant(), utm: getFirstTouchUtm() }),
            });

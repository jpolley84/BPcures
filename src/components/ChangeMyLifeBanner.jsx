// ChangeMyLifeBanner — slim top strip announcing the Change My Life Challenge
// (changemylifechallenge.com) with a live countdown to day one.
//
...
//
// The challenge is 3 days live, Sept 22-24 at 11:00am CT. It is a PAID
// challenge: no "free" anywhere in this copy, and no price is stated here
// because the price lives on changemylifechallenge.com.
//
// Three phases:
    ...
    >
      <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <span style={{ opacity: 0.92 }}>
          {live ? `happening now, ${DATE_LABEL}, 11am CT daily` : `${DATE_LABEL}, 11am CT daily`}
        </span>
      </span>
      ...
      >
        {live ? 'Join today&rsquo;s session &rarr;' : 'Save my spot &rarr;'}
      </a>
    </div>
  );
}

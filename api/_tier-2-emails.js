...
//
// CRITICAL: never pitch $27 / $47 / $97 here, these buyers own all of it.
...
// 2026-07-03: /cohort2 hard-expires (410) after 2026-08-31 — the honest,
// evergreen door is the application page. Joel replies with the next real
// start date.
...
// Skool VIP invite + Wednesday Zoom calendar link + Bonus kit promises.
...
const day0 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${sageBlock(`
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;"><strong style="color:${PALETTE.text};">1. The chapter walkthroughs.</strong> Every few days for the next month, I'm going to walk you through one corner of the Triangle in deep detail, Stress, Sugar, Sodium. The herbs, the doses, the timing, the studies. This is the same teach I do with my private clients. You get it for $97 because you said yes early.</p>
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;"><strong style="color:${PALETTE.text};">2. The Wednesday live calls.</strong> Every Wednesday at 7 PM EST, I open Zoom and we work through whoever is on. Bring your cuff. Bring your numbers. Bring the question that's been bugging you. Recordings go in Skool if you can't make it live.</p>
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0;"><strong style="color:${PALETTE.text};">3. The bonus stack.</strong> Cortisol Reset Kit unlocks Day 9. Blood Sugar 10-Day Reset unlocks Day 12. The Cook For Life Cookbook is your graduation gift on Day 30: 45 plant-rich meals built around the foods that quiet all three corners. I stagger them on purpose: one tool at a time so nothing gets ignored.</p>
    `)}
    ${clayBlock('Step 1, Join the Skool VIP room (today)', `
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 10px;">Your VIP room is inside "How to Be Your Own Doctor." Introduce yourself with a one-liner: your first name, your current morning BP, and which corner you suspect is loudest in you. That post unlocks everything else.</p>
    ...
    `)}
    ${clayBlock('Step 2: Save Wednesday 7 PM EST to your calendar', `
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 10px;">Same Zoom link every week. Bookmark it now and you'll never miss one. Block 7 to 8 PM EST on every Wednesday between now and Day 30. Bring your cuff. Bring your last 3 readings. Bring questions.</p>
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">→ <a href="${MONDAY_ZOOM_URL}" style="color:${PALETTE.accentClay};font-weight:600;text-decoration:none;">Save the Wednesday Zoom link →</a></p>
    `)}
    ${ctaButton(MONDAY_ZOOM_URL, 'Save Wednesday 7 PM EST: your live call link →')}
    ${p(`If you can't make the first Wednesday live, send me your question by reply to this email and I'll answer it on the call. The recording lands in Skool within 24 hours of the call ending.`)}
...
1. THE CHAPTER WALKTHROUGHS. Every few days for the next month, I'm going to walk you through one corner of the Triangle in deep detail: Stress, Sugar, Sodium. The herbs, the doses, the timing, the studies. This is the same teach I do with my private clients. You get it for $97 because you said yes early.

2. THE WEDNESDAY LIVE CALLS. Every Wednesday at 7 PM EST, I open Zoom and we work through whoever is on. Bring your cuff. Bring your numbers. Bring the question that's been bugging you. Recordings go in Skool if you can't make it live.

3. THE BONUS STACK. Cortisol Reset Kit unlocks Day 9. Blood Sugar 10-Day Reset unlocks Day 12. The Cook For Life Cookbook is your graduation gift on Day 30: 45 plant-rich meals built around the foods that quiet all three corners. I stagger them on purpose: one tool at a time so nothing gets ignored.

STEP 1, JOIN THE SKOOL VIP ROOM (TODAY):
Your VIP room is inside "How to Be Your Own Doctor." Introduce yourself with a one-liner: your first name, your current morning BP, and which corner you suspect is loudest in you.
→ ${SKOOL_URL}

STEP 2: SAVE WEDNESDAY 7 PM EST TO YOUR CALENDAR:
Same Zoom link every week. Bookmark it now. Block 7 to 8 PM EST every Wednesday between now and Day 30.
→ ${MONDAY_ZOOM_URL}

If you can't make the first Wednesday live, send me your question by reply to this email and I'll answer it on the call. Recording lands in Skool within 24 hours.
...
// Cohort-insider voice. Reinforces Wednesday call as the place to ask questions.
const day3 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    `)}
    ${p(`If your morning BP runs high and your blood sugar is roughly normal, Stress is almost certainly the one driving your numbers. The good news: Stress responds faster than Sodium. Most people see morning BP drop 5-8 mmHg within two weeks of moving bedtime earlier.`, { margin: '0 0 28px' })}
    ...
    `)}
    ${clayBlock('WEDNESDAY 7 PM EST: FIRST LIVE CALL', `
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 10px;">First Wednesday is two days away. Bring your baseline morning BP from this week. Bring the question about Stress that's been on your mind. We work through whoever is on, in the order they raise their hand.</p>
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">→ <a href="${MONDAY_ZOOM_URL}" style="color:${PALETTE.accentClay};font-weight:600;text-decoration:none;">Wednesday Zoom link (save this) →</a></p>
    `)}
    ${ctaButton(MONDAY_ZOOM_URL, 'See you Wednesday 7 PM EST →')}
...
I'm starting here on purpose. Most boomer-aged women I work with assume their loudest corner is Sodium. But when I dig into a full history, the lead domino is almost always Stress. And cortisol is the driver most cardiologists don't even measure.
...
If your morning BP runs high and your blood sugar is roughly normal, Stress is almost certainly the one driving your numbers. Most people see morning BP drop 5-8 mmHg within two weeks of moving bedtime earlier.
...
WEDNESDAY 7 PM EST: FIRST LIVE CALL.

First Wednesday is two days away. Bring your baseline morning BP from this week. Bring the question about Stress that's been on your mind. We work through whoever is on, in the order they raise their hand.
→ ${MONDAY_ZOOM_URL}
...
const day6 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${p(`But every time your blood sugar spikes, your insulin spikes. And insulin tells your kidneys to hold onto sodium, and held sodium pulls water into the line for 2-3 hours after every meal. More water in the line, more pressure on the line. It also feeds the cortisol loop on the back end.`)}
    ...
    ${p(`Chapter 3 lands in three days: <strong style="color:${PALETTE.text};">Sodium</strong>, the held water in the line. Plus your first bonus kit unlocks.`, { margin: '0 0 24px' })}
    ${joelSignoff()}
...
But every time your blood sugar spikes, insulin spikes. Insulin tells your kidneys to hold onto sodium, and held sodium pulls water into the line for 2-3 hours after every meal. More water in the line, more pressure on the line. It also feeds the cortisol loop.
...
Chapter 3 lands in three days: SODIUM, the held water in the line. Plus your first bonus kit unlocks.
...
// ─── DAY 9 — Chapter 3: Sodium + Cortisol Reset Kit unlock ──
// Third chapter — the held-water corner. Hibiscus + garlic + magnesium.
...
const day9 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${bigQuote('Too much water in the line. Three things drain it. Not one.')}
    ${p(`Sodium is what most people half-understand when they hear "high blood pressure" and reach for the salt shaker. Here is the real mechanism: stress sends cortisol, cortisol tells the kidneys to hold sodium. Sugar sends insulin, insulin tells the kidneys to hold sodium. The held sodium pulls water into the line and presses on the vessel walls. More water in the line, more pressure on the line. It is the corner with the most aggressive marketing (every BP supplement on Amazon promises to "support healthy vessels"), and it is the corner that responds <em>slowest</em>, because draining a line that has been overfull for years takes real weeks.`)}
    ${p(`That's why I save it for Day 9. By now you've already calmed Stress (cortisol clearance, ashwagandha working) and Sugar (walk-after-meal, Anti-BP Plate), so the kidneys are getting fewer hold-the-sodium signals. The line doesn't have to fight a cortisol storm or a glucose spike, it gets to actually drain.`, { margin: '0 0 28px' })}
    ${clayBlock('THE THREE MOVES, SODIUM CORNER', `
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 12px;"><strong style="color:${PALETTE.text};">1. Hibiscus tea (Hibiscus sabdariffa).</strong> 2-3 cups daily, brewed 6-10 minutes. Tufts 2010 RCT: 7.2 mmHg systolic reduction in 6 weeks. Mechanism: natural ACE inhibition (same pathway as lisinopril, gentler), it helps the line let go and ease the held water. NOT flavored hibiscus blends, they're 80% other tea by weight. Look for "100% hibiscus" on the label.</p>
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 12px;"><strong style="color:${PALETTE.text};">2. Garlic stack.</strong> 2 fresh cloves daily, crushed, wait 10 minutes for alliinase→allicin conversion, then eat. OR Kyolic Aged Garlic Extract 600-1,200 mg daily. 2019 Journal of Clinical Hypertension meta-analysis: 8.3 mmHg systolic, 5.5 mmHg diastolic across 550 patients. Mechanism: allicin → hydrogen sulfide → the walls relax and the line widens, so the same water presses less.</p>
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0;"><strong style="color:${PALETTE.text};">3. Magnesium taurate, 200 mg with dinner.</strong> NOT magnesium oxide (4% absorption, near-useless). Taurate is the cardiovascular-specific form, magnesium plus taurine, both help the vessel walls relax and stay supple. Adds 2 mmHg systolic on average and pairs with the hibiscus and garlic without interaction risk. Pair all three with potassium-rich foods, beets, leafy greens, beans, which signal the kidneys to release the held sodium and let the line drain.</p>
    `)}
    ${p(`Three moves. The line starts to drain inside 14 days. By Day 30 of this Challenge, most readers are seeing 5-8 mmHg drops just from the Sodium stack alone, on top of the Stress + Sugar gains you're already building.`, { margin: '0 0 28px' })}
    ${bigQuote('Your first bonus is here.')}
    ${sageBlock(`
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;"><strong style="color:${PALETTE.text};">The 10-Day Cortisol Reset Kit</strong>, your first bonus from the Challenge stack. This is the same Cortisol Reset Kit I include in the deeper Sprint program. It walks you through the Stress corner with day-by-day prompts: morning sun timing, ashwagandha protocol, gratitude practice scripts, paced breathing, and a sleep audit you can actually finish in 5 minutes.</p>
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">Don't read the whole thing today. Use it as a 10-day companion to Chapter 1 (Stress). One micro-action per day. Stack on top of the Triangle moves you already started.</p>
    `)}
    ${ctaButton(BONUS_CORTISOL_URL, 'Get your Cortisol Reset Kit →')}
    ...
    ${p(`Pills manage output. Protocol fixes input. You're now running the full Triangle: Stress, Sugar, Sodium. Same loop, three doors in. That's why this Method works when the single-supplement experiments your friends tried did not. The system treats your symptom, the pill hides the number. The Triangle heals the loop, the cause. That is why blood pressure gets managed for thirty years instead of healed.`)}
    ${joelSignoff()}
...
Plus your first bonus is unlocked at the bottom of this email. The 10-Day Cortisol Reset Kit is ready for download, the same Cortisol Reset Kit I include in the deeper Sprint program.

TOO MUCH WATER IN THE LINE. THREE THINGS DRAIN IT. NOT ONE.

Sodium is what most people half-understand when they hear "high blood pressure" and reach for the salt shaker. The real mechanism: stress sends cortisol, cortisol tells the kidneys to hold sodium. Sugar sends insulin, insulin tells the kidneys to hold sodium. Held sodium pulls water into the line and presses on the vessel walls. More water in the line, more pressure on the line. It's the corner with the most aggressive marketing (every BP supplement on Amazon promises to "support healthy vessels"), and it responds SLOWEST, because draining a line that's been overfull for years takes real weeks.

That's why I save it for Day 9. By now you've already calmed Stress and Sugar, so the kidneys get fewer hold-the-sodium signals. The line doesn't have to fight a cortisol storm or a glucose spike, it gets to actually drain.

THE THREE MOVES, SODIUM CORNER:

1. Hibiscus tea (Hibiscus sabdariffa). 2-3 cups daily, brewed 6-10 minutes. Tufts 2010 RCT: 7.2 mmHg systolic reduction in 6 weeks. Mechanism: natural ACE inhibition (same pathway as lisinopril, gentler), it helps the line let go and ease the held water. NOT flavored hibiscus blends, they're 80% other tea by weight. Look for "100% hibiscus" on the label.

2. Garlic stack. 2 fresh cloves daily, crushed, wait 10 minutes for alliinase→allicin conversion, then eat. OR Kyolic Aged Garlic Extract 600-1,200mg daily. 2019 Journal of Clinical Hypertension meta-analysis: 8.3 mmHg systolic, 5.5 mmHg diastolic across 550 patients. Mechanism: allicin → hydrogen sulfide → the walls relax and the line widens, so the same water presses less.

3. Magnesium taurate, 200mg with dinner. NOT magnesium oxide (4% absorption, near-useless). Taurate is the cardiovascular-specific form. Adds 2 mmHg systolic on average and pairs with hibiscus and garlic without interaction risk. Pair all three with potassium-rich foods, beets, leafy greens, beans, which signal the kidneys to release the held sodium and let the line drain.

Three moves. The line starts to drain inside 14 days. By Day 30 of this Challenge, most readers see 5-8 mmHg drops from the Sodium stack alone, on top of the Stress + Sugar gains you're already building.

YOUR FIRST BONUS IS HERE.

The 10-Day Cortisol Reset Kit, your first bonus from the Challenge stack. The same Cortisol Reset Kit I include in the deeper Sprint program. Day-by-day prompts: morning sun timing, ashwagandha protocol, gratitude scripts, 4-7-8 breath, 5-minute sleep audit.

Don't read the whole thing today. Use it as a 10-day companion to Chapter 1 (Stress). One micro-action per day.

→ Get your Cortisol Reset Kit (it lives in your library): ${BONUS_CORTISOL_URL}

Next bonus, Blood Sugar 10-Day Reset, unlocks on Day 12. The Cook For Life Cookbook is your graduation gift on Day 30.

Pills manage output. Protocol fixes input. You're now running the full Triangle: Stress, Sugar, Sodium. Same loop, three doors in. That's why this Method works when the single-supplement experiments your friends tried did not. The system treats your symptom, the pill hides the number. The Triangle heals the loop, the cause. That is why blood pressure gets managed for thirty years instead of healed.

Joel
RN, BraveWorks

P.S. Wednesday's call is in days. Halfway through the cohort, the question that comes up most is "should I be tapering my meds yet?" Short answer: usually no, not until Day 30+ with sustained readings. Long answer: bring it to Wednesday and we'll work through your specific case live.
...
// ─── DAY 12 — Blood Sugar Kit unlock + Wednesday call reminder ──────────
// Second bonus delivery. Pre-Wednesday reminder. Reinforce midway momentum.
const day12 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${ctaButton(BONUS_BLOODSUGAR_URL, 'Get your Blood Sugar 10-Day Reset →')}
    ...
    `)}
    ${bigQuote('Wednesday night, the live BP demo.')}
    ${sageBlock(`
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;">On Wednesday's call I'm going to do something I don't do every week: a <strong style="color:${PALETTE.text};">live BP demo</strong>. I'll put my own cuff on, take a reading on camera, then walk through how I read my own numbers, what counts as a good reading, what to throw out, why the second reading on the same arm matters more than the first, and what the spread between morning and evening tells you about which corner is loudest.</p>
    ...
    `)}
    ${clayBlock('WEDNESDAY 7 PM EST: BRING YOUR CUFF', `
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 10px;">Same Zoom link as last Wednesday, save it once, use it for all 4 weeks of the Challenge.</p>
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">→ <a href="${MONDAY_ZOOM_URL}" style="color:${PALETTE.accentClay};font-weight:600;text-decoration:none;">Wednesday Zoom link →</a></p>
    `)}
    ${ctaButton(MONDAY_ZOOM_URL, 'See you Wednesday 7 PM EST →')}
    ${p(`You're 12 days into a 30-day cohort. Most of the structural protocols are in your hands now, Stress herbs, Sugar plate, Sodium stack. The next 18 days are about <em>doing them</em> long enough for the morning numbers to start telling a different story.`, { margin: '0 0 28px' })}
...
→ Get your Blood Sugar 10-Day Reset (it lives in your library): ${BONUS_BLOODSUGAR_URL}
...
WEDNESDAY NIGHT, THE LIVE BP DEMO.

On Wednesday's call I'm going to do something I don't do every week: a live BP demo. I'll put my own cuff on, take a reading on camera, then walk through how I read my own numbers, what counts as a good reading, what to throw out, why the second reading on the same arm matters more than the first, and what the spread between morning and evening tells you about which corner is loudest.
...
WEDNESDAY 7 PM EST: BRING YOUR CUFF.

Same Zoom link as last Wednesday, save it once, use it for all 4 weeks of the Challenge.
→ ${MONDAY_ZOOM_URL}

You're 12 days into a 30-day cohort. Most of the structural protocols are in your hands now, Stress herbs, Sugar plate, Sodium stack. The next 18 days are about doing them long enough for the morning numbers to start telling a different story.
...
const day15 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    `)}
    ${p(`I read every reply. I'll mention themes on Wednesday's call.`)}
...
I read every reply. I'll mention themes on Wednesday's call.
...
P.S. If your numbers HAVE NOT moved at Day 15, that means one of three things. (1) You haven't fully run the protocol yet, be honest with yourself, are you on ashwagandha + hibiscus + the walk-after-meal? (2) There's a hidden cause we haven't found yet, sleep apnea is the big one, screened for in 40-80% of resistant hypertension. (3) Your loudest corner is actually Sodium, and a line that has been overfull for years takes 28+ days to fully drain. Tell me on Wednesday and we'll work through which it is.
...
const day18 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${bigQuote('STORY: Consandra closed in 16 days.')}
    ${sageBlock(`
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;">Consandra Taylor was one of my first paid clients inside the Sprint. She came in May 15 with elevated BP, type-2 diabetes, mid-fifties, two meds running.</p>
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0 0 14px;">First 30 days: same chapter walkthroughs you're getting now. Stress, Sugar, Sodium. Same Triangle protocol. Same herbs.</p>
...
Consandra Taylor was one of my first paid clients inside the Sprint. Elevated BP, type-2 diabetes, mid-fifties, two meds.

First 30 days: same chapter walkthroughs you're getting now. Stress, Sugar, Sodium. Same Triangle protocol. Same herbs.
...
Her doctor lowered her metformin first. Her doctor lowered her amlodipine second. Consandra's writing her own bonus chapter for the Sprint cookbook this month, the woman who 90 days ago thought she'd be on pills for life is now teaching the women coming in behind her.
...
Look at the application now. Don't apply yet, just read what it is.
→ ${COHORT2_URL}

Day 22: I'll tell you exactly what Consandra's Wednesday looks like inside the Sprint.
...
const day22 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    `)}
    ${bigQuote('BRIDGE: What her actual Wednesday looks like.')}
    ${p(`This is the part nobody describes in advance. So here it is, hour by hour.`, { margin: '0 0 28px' })}
    ${clayBlock('WAKITA\'S WEDNESDAY INSIDE THE SPRINT', `
    ...
    ${p(`Day 26 of your Challenge, the guarantee and exactly how the application works.`, { margin: '0 0 28px' })}
    ${joelSignoff()}
...
BRIDGE: WHAT HER ACTUAL WEDNESDAY LOOKS LIKE.

This is the part nobody describes in advance. So here it is, hour by hour.

WAKITA'S WEDNESDAY INSIDE THE SPRINT:
...
→ 10 AM: I review. I open every Sprint client's tracker between 9 and 11 AM Wednesday. I look at trend direction, variance, and outliers. I leave one comment per client.

→ 7 PM: The Wednesday call (Sprint cohort joins the Challenge live call). 60 minutes, full cohort on Zoom. Patterns I saw that week. Each client gets a 3-5 minute slot to ask the one question that's been bugging them.
...
Five women is the most I can review every Wednesday with real attention. Tried thirty in the first cohort I ever ran. Missed things. Clients drifted. Cut to five and outcomes more than doubled.

Cohort 2 stays small on purpose. No fake deadline: the group opens when there is a real cohort ready. Apply and I will tell you the next real start date. Application questions on Day 26.
...
Day 26 of your Challenge, the guarantee and exactly how the application works.
...
// ─── DAY 26 — Cohort 2 mechanism (full picture, honest invitation) ────
// Deep dive into the offer. No fake deadlines. Guarantee. FAQ.
const day26 = {
...
→ Weekly tracker review. Every Wednesday I open every client's tracker between 9 and 11 AM ET. One comment per client.
→ The Doctor Conversation Script + Med Wean Tracker.
→ A smaller, tighter Skool VIP room. A handful of women only.
...
The full Sprint is $1,997. The application itself never charges you anything. You apply, we talk, I tell you the next real start date, and you decide with the full picture in hand. There is a payment plan option on the application. Same total, no interest.

THE GUARANTEE.

Inside the first 14 days of the Sprint, if you've shown up to both Wednesday calls, completed both weekly trackers, and you don't see a clear path to your medication conversation, write me a paragraph telling me what's missing and I'll refund the Sprint in full. Not a fight. Not 27 forms. One paragraph.

THE THREE COMMON QUESTIONS:

→ "Can I do it if I work full-time?" Yes. Most Cohort 1 women worked full-time. The Wednesday call is the only fixed live commitment.
...
const day30 = {
  ...
  htmlBody: ({ firstName, unsubUrl }) => `
    ...
    ${clayBlock('THE COOK FOR LIFE COOKBOOK, UNLOCKED TODAY', `
      ...
      <p style="font-size:15px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">→ <a href="${BONUS_COOKBOOK_URL}" style="color:${PALETTE.accentClay};font-weight:600;text-decoration:none;">Get your Cook For Life Cookbook (your graduation gift) →</a></p>
    `)}
    ${ctaButton(BONUS_COOKBOOK_URL, 'Get your Cook For Life Cookbook →')}
    ${bigQuote('Either way, you have the protocol now.')}
    ${p(`That's what I want you to walk away with most. The Triangle protocol, Stress herbs, Sugar plate, Sodium stack, is yours forever. The 30 days bought you the chapters, the bonus kits, the live Wednesdays, the Skool VIP room, the cookbook. <strong style="color:${PALETTE.text};">That doesn't get taken back at graduation.</strong> You own the tools.`)}
...
Forty-five plant-rich meals built around the foods that quiet all three corners. Joel's grandmother's bean soup is page 22. The Anti-BP Plate template gets its own chapter with 15 dinner-ready variations. The hibiscus-cinnamon iced tea recipe lives at page 38.
...
→ Get your Cook For Life Cookbook (your graduation gift, in your library): ${BONUS_COOKBOOK_URL}

EITHER WAY, YOU HAVE THE PROTOCOL NOW.

The Triangle protocol, Stress herbs, Sugar plate, Sodium stack, is yours forever. The 30 days bought you the chapters, the bonus kits, the live Wednesdays, the Skool VIP room, the cookbook. THAT DOESN'T GET TAKEN BACK AT GRADUATION. You own the tools.

Whether you walk into Cohort 2 now or come back in three months, the Triangle stays with you. The herbs stay with you. The "AND not INSTEAD OF" frame stays with you. Pills manage output. Protocol fixes input. That sentence is yours now.

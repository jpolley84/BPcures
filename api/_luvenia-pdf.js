// Generates a branded PDF of Luvenia's pre-call intake answers using pdfkit.
//
// Returns a Buffer. Used by:
//   - /api/luvenia-intake.js  — attaches to Joel's notification email
//   - /api/luvenia-intake-pdf — streams as Content-Type: application/pdf for
//     Luvenia's "Download" button on the success page
...
export function generateLuveniaPDF({ answers, submittedAt }) {
  return new Promise((resolve, reject) => {
    try {
      const doc = new PDFDocument({
        ...
        bufferPages: true,
        info: {
          Title: 'Luvenia N Truss — Pre-Call Intake',

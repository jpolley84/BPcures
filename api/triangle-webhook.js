...
const TEA_RESEARCH = [
  { name: 'Hibiscus', corner: 'Sodium', what: 'A Tufts RCT and a 2022 meta-analysis studied it for lowering systolic blood pressure in adults; the meta-analysis found a pooled drop of about 7 mmHg against placebo.', url: 'https://pubmed.ncbi.nlm.nih.gov/20018807/' },
  { name: 'Hawthorn', corner: 'Arterial pressure', what: 'A 2025 meta-analysis of placebo-controlled clinical trials found a clinically significant systolic drop in hypertension. It can interact with cardiac medications, so tell your prescriber.', url: 'https://pubmed.ncbi.nlm.nih.gov/40732315/' },
  ...
  { name: 'Spearmint', corner: 'New, hormone support', what: 'Two trials in women with PCOS or hirsutism studied spearmint tea for lowering androgens and both found significant drops in testosterone. In the larger trial, the objective hair growth measure did not improve significantly, so no claim is made about unwanted hair.', url: 'https://pubmed.ncbi.nlm.nih.gov/19585478/' },
  { name: 'Fennel seed', corner: 'New, hormone support', what: 'A meta-analysis of 12 randomized trials studied fennel for period pain, and separate trials in postmenopausal women studied fennel capsules or powder for menopause symptom score and estradiol levels. All used concentrated forms rather than tea. Ask your doctor first if you have a hormone sensitive condition, and skip it in pregnancy or nursing.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7697926/' },
...
const ALLIN_CANCEL_SECONDS = {
  ...
  // MONTHLY: negotiated for Brenda Dancil-Jones 2026-08-26, who asked for her
  // $1,800 balance in 4 payments; 4 x $450 monthly lands exactly on $1,800.
  // Charges at ~day 0, 30, 61, 91; a 5th would post ~day 122, so 105 days
  // sits safely between the 4th and 5th.
  'balance-4pay-450': 105 * 24 * 60 * 60,
};

...
const day2 = {
  ...
  htmlBody: ({ firstName }) => `
    ...
    ${upsellFooter({
      ...
      body: 'The sodium-potassium ratio is the first lever we work in the live room. My Weekly Reset group meets Wednesdays at 7 PM ET, the live call, the Skool community, and the full ebook library. $27/month, and your first 7 days are free, so your first session costs nothing.',
      ctaLabel: 'Join the Weekly Reset',
      ctaUrl: SKOOL_URL,
    })}
    ${footerSecondaryCTAs()}
  `,
...
The Weekly Reset, my live group call every Wednesday at 7 PM ET, plus the Skool community and the full ebook library. $27/month, first 7 days free, so your first session costs nothing.
→ ${SKOOL_URL}
...
const day5 = {
  ...
  htmlBody: ({ firstName }) => `
    ...
    ${sageBlock(`
      ...
      <p style="font-size:16px;line-height:1.65;color:${PALETTE.textSoft};margin:0;">If you usually eat bread at lunch, swap it for a romaine wrap or skip it entirely and add an extra protein. If cereal at breakfast, swap it for half an avocado and a handful of walnuts.</p>
    `)}
    ...
    ${upsellFooter({
      ...
      body: 'The sodium audit + the protein-fat-fiber rule are exactly what we work in my Weekly Reset group. Live call every Wednesday at 7 PM ET, the Skool community, and the full ebook library, the same weekly rhythm that built Marlene\'s outcome. $27/month, first 7 days free, so your first session is on me.',
      ctaLabel: 'Join the Weekly Reset',
      ctaUrl: SKOOL_URL,
    })}
    ${footerSecondaryCTAs()}
...
The Weekly Reset, my live group call every Wednesday at 7 PM ET, the Skool community, and the full ebook library. $27/month, first 7 days free, so your first session is on me.
→ ${SKOOL_URL}
...
const day10 = {
  ...
  htmlBody: ({ firstName }) => `
    ...
    ${p(`If you want my eyes on your numbers live, every Wednesday at 7 PM ET I unravel the Triangle with the group in my <strong>Weekly Reset</strong>. It's $27/month for the live call, the Skool community, and the full ebook library, and your first 7 days are free, so you can sit in on your first session for nothing.`)}
    ${ctaButton(SKOOL_URL, 'Join the Weekly Reset, first session free →')}
    ${joelSignoff()}
...
→ Want my eyes on your numbers live? The Weekly Reset: ${SKOOL_URL}
Wednesdays at 7 PM ET live with me + the Skool community + the full ebook library. $27/month, first 7 days free, your first session costs nothing.
...
P.S. The Weekly Reset has the full herb stack + Skool community + my live Wednesday 7 PM ET group call. $27/month, first 7 days free: ${SKOOL_URL}
`,
};
...
If you wake at 2-4 AM and can't fall back asleep, that's cortisol. Tomorrow: paced breathing.
...
P.S. The Weekly Reset layers walking, sleep, breathing, supplements in the right order, live every Wednesday 7 PM ET. $27/month, first 7 days free: ${SKOOL_URL}
`,
};
...
P.S. The Weekly Reset has lab interpretation + the Doctor Conversation Script, live every Wednesday 7 PM ET. $27/month, first 7 days free: ${SKOOL_URL}
`,
};
